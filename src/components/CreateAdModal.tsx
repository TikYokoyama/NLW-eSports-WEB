...
export function CreateAdModal() {
    ...
    async function handleCreateAd(event: FormEvent) {
        event.preventDefault() // para nao sair do modal
        //forcando o target a ser um formulario
                    ...
                    <div className="flex gap=6">
                        <div className="flex flex-col gap-2">
                            ...
                            >
                                ...
                                <ToggleGroup.Item
                                    value="2"
                                    className={`w-8 h-8 rounde ${weekDays.includes('2') ? 'bg-violet-500' : "bg-zinc-900"}`}
                                    title="Terca">
                                    T
                                </ToggleGroup.Item>
                                <ToggleGroup.Item
                                    value="3"
                                    className={`w-8 h-8 rounde ${weekDays.includes('3') ? 'bg-violet-500' : "bg-zinc-900"}`}
                                    title="Quarta">
                                    Q
                                </ToggleGroup.Item>
                                <ToggleGroup.Item
                                    value="4"
                                    className={`w-8 h-8 rounde ${weekDays.includes('4') ? 'bg-violet-500' : "bg-zinc-900"}`}
                                    title="Quinta">
                                    Q
                                </ToggleGroup.Item>
                                <ToggleGroup.Item
                                    value="5"
                                    className={`w-8 h-8 rounde ${weekDays.includes('5') ? 'bg-violet-500' : "bg-zinc-900"}`}
                                    title="Sexta">
                                    S
                                </ToggleGroup.Item>
                                <ToggleGroup.Item
                                    value="6"
                                    className={`w-8 h-8 rounde ${weekDays.includes('6') ? 'bg-violet-500' : "bg-zinc-900"}`}
                                    title="Sabado">
                                    S
                                </ToggleGroup.Item>
                            </ToggleGroup.Root>
